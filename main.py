...
Original file is located at
    https://colab.research.google.com/drive/1EM6Yr7h0BNHWSAdi1G8P2HtngEUIwIBl
...
sentence = "Your name is " + name + ", your surname is " + surname + ", your age is " + age
print(sentence)
...
print("Your grade according to the Polish system is:", grade)
